...
public partial class mobSpawner : Node2D
{
	...
	public override void _Ready()
	{
		...
		creaturesList.Add((PackedScene)ResourceLoader.Load("res://src/enemies/goblin.tscn"));
		creaturesList.Add((PackedScene)ResourceLoader.Load("res://src/enemies/pawn.tscn"));
		creaturesList.Add((PackedScene)ResourceLoader.Load("res://src/enemies/sheep.tscn"));
	}
